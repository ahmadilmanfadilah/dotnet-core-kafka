                ...
                try
                {
                    while (true)
                    {
                        try
                        {
                            ...
                            Console.WriteLine($"Received message value {consumeResult.Value}");
                            Console.WriteLine("===========");
                            ...
                            // {
                                ...
                                try
                                {
                                     Console.WriteLine($"Commit end of topic {consumeResult.Topic}, partition {consumeResult.Partition}, offset {consumeResult.Offset}.");
